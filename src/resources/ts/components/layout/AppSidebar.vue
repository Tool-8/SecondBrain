    ...
    >
        ...
        >
            ...
            <div class="py-2 px-4 border-none mt-auto">
                <ul class="space-y-1">
                    <li
                        class="flex justify-between gap-1 p-1 rounded-lg bg-gray-100 dark:bg-neutral-800"
                    >
                        <div
                        ...
                        >
                            ...
                            >
                                <path
                                    d="M18.2,11.2a22.6,22.6,0,0,0-1,6.9c.3,8.8,6.7,16.8,15,19.7A14.5,14.5,0,0,1,26.3,39H24.6a15,15,0,0,1-6.4-27.7m6-6.2h-.1a19.2,19.2,0,0,0-17,21.1A19.2,19.2,0,0,0,24.2,42.9h2.1a19.2,19.2,0,0,0,14.4-6.4A.9.9,0,0,0,40,35H38.1c-8.8-.5-16.6-8.4-16.9-17.1A17.4,17.4,0,0,1,25,6.6,1,1,0,0,0,24.2,5Z"
                                />
                            </svg>
                        </div>
                        <div
