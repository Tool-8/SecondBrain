...
function applyFormat(type: 'bold' | 'italic' | 'underline') {
    ...
    const alreadyWrapped =
        selectedText.startsWith(start) &&
        selectedText.endsWith(end)
        ...
        <div class="bg-white dark:bg-neutral-900 sticky top-0">
            ...
            <div class="flex px-6 py-1 border-b-1 border-gray-100 dark:border-neutral-800">
                ...
                <div class="pr-4 flex gap-px border-r-1 border-gray-100 dark:border-neutral-800 font-jetbrains">
                    <button class="px-2 cursor-pointer rounded hover:bg-gray-100 dark:hover:bg-neutral-800" title="undo" @click="undoEdit">
                        <svg 
                    ...
                    <button class="px-2 cursor-pointer rounded hover:bg-gray-100 dark:hover:bg-neutral-800" title="redo" @click="redoEdit">
                        <svg 
                            xmlns="http://www.w3.org/2000/svg"
                            class="size-3 dark:text-white"
                            fill="currentColor"
                ...
                <div class="px-4 flex gap-px border-r-1 border-gray-100 dark:border-neutral-800 font-jetbrains">
                    <button class="px-2 font-bold cursor-pointer rounded hover:bg-gray-100 dark:hover:bg-neutral-800" title="grassetto" @click="applyFormat('bold')">B</button>
                    <button class="px-2 font-bold italic cursor-pointer rounded hover:bg-gray-100 dark:hover:bg-neutral-800" title="italico" @click="applyFormat('italic')">I</button>
                    <button class="px-2 font-bold underline cursor-pointer rounded hover:bg-gray-100 dark:hover:bg-neutral-800" title="sottolineato" @click="applyFormat('underline')">U</button>
                </div>
